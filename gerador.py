...
sg.theme('DarkGray14') # tema de cores

# setando config do menu_layout
menu_layout = [
    ['File', ['About', 'Exit']]
    	]
...
while True:
	...
	if event == 'About':
		sg.Popup('''
           **************************************
              Programador: Thiago Santos 
           **************************************
           
            O programa foi criado com o intuito 
            de gerar senhas para segurança de 
            usuários.
           ''')
